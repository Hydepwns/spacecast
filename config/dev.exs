...
config :spacecast, Spacecast.Repo,
  ...
  database: System.get_env("DEV_DB_NAME") || "spacecast_dev",
  stacktrace: true,
...
config :spacecast, SpacecastWeb.Endpoint,
  ...
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:spacecast, ~w(--sourcemap=inline --watch)]}
  ]
...
config :spacecast, SpacecastWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/spacecast_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :spacecast, dev_routes: true
