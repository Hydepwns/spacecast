defmodule Spacecast.Resources.DeveloperTools do
  ...
  defdelegate start_debug_session(resource_module, id, opts \\ []), to: Spacecast.Resources.DebugSession, as: :start_session
  ...
  defdelegate compare_debug_snapshots(session_id, snapshot1_index, snapshot2_index), to: Spacecast.Resources.DebugSession, as: :compare_snapshots
  ...
  defdelegate create_resource_sandbox(resource_modules, opts \\ []), to: Spacecast.Resources.ResourceSandbox, as: :create_sandbox
  defdelegate apply_sandbox_event(sandbox_id, resource_type, instance_id, event), to: Spacecast.Resources.ResourceSandbox, as: :apply_event
  ...
  defdelegate generate_event_documentation(resource_module), to: Spacecast.Resources.EventDocumentation, as: :generate_documentation

  # Test Event Generation functions
  defdelegate generate_test_events(resource_module, id, event_specs, opts \\ []), to: Spacecast.Resources.TestEventGenerator
