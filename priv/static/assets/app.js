(() => {
  ...
  // js/components/file_download.js
  var file_download_exports = {};
  __export(file_download_exports, {
    default: () => file_download_default
  });
  var FileDownload, file_download_default;
  var init_file_download = __esm({
    "js/components/file_download.js"() {
      FileDownload = {
        mounted() {
      ...
      file_download_default = FileDownload;
    }
  });
  ...
  var componentRegistry = {
    ...
    "body": [
      ...
      () => Promise.resolve().then(() => (init_file_download(), file_download_exports))
    ],
